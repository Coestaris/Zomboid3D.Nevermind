...
decalreCastInstruction(instruction_cast_f64_i8,  double, int8_t)
decalreCastInstruction(instruction_cast_f64_i16, double, int16_t)
decalreCastInstruction(instruction_cast_f64_i32, double, int32_t)
decalreCastInstruction(instruction_cast_f64_i64, double, int64_t)
decalreCastInstruction(instruction_cast_f64_u8,  double, uint8_t)
decalreCastInstruction(instruction_cast_f64_u16, double, uint16_t)
decalreCastInstruction(instruction_cast_f64_u32, double, uint32_t)
decalreCastInstruction(instruction_cast_f64_u64, double, uint64_t)
decalreCastInstruction(instruction_cast_f64_f32, double, float)
decalreCastInstruction(instruction_cast_f64_f64, double, double)
