...
declarePushInstruction(instruction_push_arr, void*)
...
declarePopInstruction(instruction_pop_arr, void*)
...
void instruction_VGet(struct _nmEnvironment* env, void** data)
{
    ...
    *(int32_t*)data[0] = *(int32_t*)(array->data + offset * array->type->typeBase);
