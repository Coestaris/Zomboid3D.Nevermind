...
namespace Nevermind.Compiler.Lexemes.Expressions
{
    internal class Operator
    {
        ...
        public static readonly List<Operator> Operators = new List<Operator>
        {
            ...
            //Equal operators
            new Operator(new List<TokenType> { TokenType.PlusSign,        TokenType.EqualSign     }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.MinusSign,       TokenType.EqualSign     }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.MultiplySign,    TokenType.EqualSign     }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.DivideSign,      TokenType.EqualSign     }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.AmpersandSign,   TokenType.EqualSign     }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.CircumflexSign,  TokenType.EqualSign     }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.OrSign,          TokenType.EqualSign     }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.EqualSign                                }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.EqualSign                                }, 1,  new Function<IntegerType, IntegerType, IntegerType>()),
            new Operator(new List<TokenType> { TokenType.ComaSign                                 }, 0,  new Function<IntegerType, IntegerType, IntegerType>()),
        };
    }
}